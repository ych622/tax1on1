...
<?php do_action('register_form'); ?>
	<p id="reg_passmail"><?php _e('请填写真实邮箱地址，否则无法找回密码！密码会在注册后立刻显示，请即时登陆修改密码. ^_^') ?></p>
	<br class="clear" />
	<input type="hidden" name="redirect_to" value="<?php echo esc_attr( $redirect_to ); ?>" />
...
<?php		exit;
	...
	elseif	( isset($_GET['checkemail']) && 'registered' == $_GET['checkemail'] )
        $errors->add('registered', __('注册成功！Registration complete！请在登陆后修改足够安全的密码！Please change your password asap! username: ' . $_COOKIE["u"] . ' password: ' . $_COOKIE["user_pass"]), 'message');
