...
<p><?php _e("Sorry, but you are looking for something that isn't here. Try the search box. 对不起，您打开的页面有问题，试下搜索框吧。","atahualpa"); ?></p>

<div class="dtree">
      <?php if(function_exists('wpdt_list_categories')){<br />
             wpdt_list_categories('orderby=order');}<br />
?></div>
