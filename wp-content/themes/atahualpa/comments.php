...
$fields =  array(
	...
	'email'  => '<p><input class="text email" id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . '  tabindex="2" />' . 
				'&nbsp;&nbsp;<label for="email"><strong>' . __( 'Email' ,'atahualpa') . '</strong> ' . ( $req ? __('(邮箱提交后不会显示，如有新回复您会收到邮件通知。) (我们不会出售您的邮件地址)','atahualpa') : '' ) . '</label></p>',
	'url'    => '<p><input class="text url" id="url" name="url" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30"  tabindex="3" />' . 
				'&nbsp;&nbsp;<label for="url">' . __( '网站可留空','atahualpa' ) . '</label></p>'
); 
...
$comment_form_settings = array(
	...
	'comment_field'        => '<p><textarea name="comment" id="comment" rows="5" cols="10" tabindex="4"></textarea></p>',
	...
	'id_form'              => 'commentform',
	'id_submit'            => '提交',
	'title_reply'          => __( '留言','atahualpa' ),
	'title_reply_to'       => __( '留言给%s','atahualpa' ),
	'cancel_reply_link'    => __( '取消回复','atahualpa' ),
	'label_submit'         => __( '发表回复' ,'atahualpa')
);
?>
