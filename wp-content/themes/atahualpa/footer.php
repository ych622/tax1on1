...
<td id="right-inner">
	...
	<?php if ( !dynamic_sidebar('Right Inner Sidebar') ) : ?>
		...
		<a href="http://wordpress.org/"  rel="nofollow">euismod dolor nec</a> pretium. Nunc ut tristique massa. </p>
...
<td id="right">
	...
	<?php if ( !dynamic_sidebar('Right Sidebar') ) : ?>
    	...
    	<ul>
    		...
    		<li><a href="http://wordpress.org/" rel="nofollow" title="
    		<?php _e('Powered by WordPress','updated based on atahualpa'); ?>">
    		<?php _e('WordPress','updated based on atahualpa'); ?></a></li>
    		<?php wp_meta(); ?>
    	</ul>
    	</div>
