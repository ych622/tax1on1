...
?>
	...
	<div class="search-bar header-drop-down">
		<div class="search-head">
			<form action="/sitesearch/" method="get" id="search-form" autocomplete="off" data-ajax="true">
				<?php if( wps_is_in_preview_mode() ):?>
					<input type="hidden" name="wps_preview" value="1"/>	
				<?php endif; ?>
				
				<div class="search-input-wrap input-wrap">
					<label id="search-input-label">如搜索多个关键词 请使用空格隔开 ^_^</label>
...
?>
	<div id="footer" class="site-footer">
		<p>Tax1on1 is an IRC 501(c)(3) nonprofit organization.</a></p>
        <p>美国税1on1是一个IRS认证的501(c)(3)免税机构.</a></p>
		<p>© 2012-2014 Tax1on1™ | <a href="#" id="view_full_site">View Full Site</a></p>
	</div>
<?php
}
endif;
