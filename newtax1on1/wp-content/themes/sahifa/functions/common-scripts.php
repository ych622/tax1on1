...
.top-nav, .top-nav ul ul {background:<?php echo $topbar_bg['color'] ?> <?php if( !empty($topbar_bg['img']) ){ ?>url('<?php echo $topbar_bg['img'] ?>')<?php } ?> <?php echo $topbar_bg['repeat'] ?> <?php echo $topbar_bg['attachment'] ?> <?php echo $topbar_bg['hor'] ?> <?php echo $topbar_bg['ver'] ?>;}<?php echo "\n"; ?>
<?php endif; ?>
...
#main-content {background:<?php echo $content_bg['color'] ?> <?php if( !empty($content_bg['img']) ){ ?>url('<?php echo $content_bg['img'] ?>')<?php } ?> <?php echo $content_bg['repeat'] ?> <?php echo $content_bg['attachment'] ?> <?php echo $content_bg['hor'] ?> <?php echo $content_bg['ver'] ?>;}<?php echo "\n"; ?>
<?php endif; ?>
<?php $boxes_bg = tie_get_option( 'boxes_bg' ); 
if( !empty( $boxes_bg['img']) || !empty( $boxes_bg['color'] ) ): ?>
.cat-box-content, #sidebar .widget-container, .post-listing, .column2 li.first-news, .wide-box li.first-news {background:<?php echo $boxes_bg['color'] ?> <?php if( !empty($boxes_bg['img']) ){ ?>url('<?php echo $boxes_bg['img'] ?>')<?php } ?> <?php echo $boxes_bg['repeat'] ?> <?php echo $boxes_bg['attachment'] ?> <?php echo $boxes_bg['hor'] ?> <?php echo $boxes_bg['ver'] ?> !important;}<?php echo "\n"; ?>
<?php endif; ?>
...
footer#theme-footer {background:<?php echo $footer_bg['color'] ?> <?php if( !empty($footer_bg['img']) ){ ?>url('<?php echo $footer_bg['img'] ?>')<?php }?> <?php echo $footer_bg['repeat'] ?> <?php echo $footer_bg['attachment'] ?> <?php echo $footer_bg['hor'] ?> <?php echo $footer_bg['ver'] ?>;}<?php echo "\n"; ?>
<?php endif; ?>
