...
if ( isset( $_GET['page'] ) && $_GET['page'] == 'panel' ) {
	...
	function tie_pointer_print_scripts() {
		...
		$pointer_content .= "<p> If you like ".theme_name." theme, please don\'t forget to <a href=\'http://themeforest.net/downloads?ref=mo3aser\' target=\'_blank\'><strong>rate it</strong></a> :)</p>";
	?>
